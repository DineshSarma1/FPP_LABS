...
public class Prog2 {
	...
	public static void main(String[] args) {
		...
		String[] splitedRows = records.split(":");
		
		String[] collectionOfIds = new String[splitedRows.length];
		
		for(int i = 0; i< splitedRows.length ; i++) {
			String[] seperatedRowsValues = splitedRows[i].split(",");
			collectionOfIds[i] = seperatedRowsValues[0];
		}
		
		//System.out.println(Arrays.toString(collectionOfIds));
		
		for(String id : collectionOfIds) {
